...
(4001, 'Camera', 4, 0, '2024-04-23 21:57:35', 'Capture high-quality photos and videos with this camera.'),
...
(1, '1', 1, 1001, 2, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 300000, '2024-04-01 00:00:00', '2024-04-28 09:07:12', 1),
(2, '2', 1, 1002, 2, 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 250000, '2024-04-01 00:00:00', '2024-04-29 06:10:43', 2),
(3, '3', 3, 2001, 1, 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 300000, '2024-04-01 00:00:00', '2024-04-27 20:01:25', 1),
(4, '4', 4, 2002, 6, 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.', 400000, '2024-04-01 00:00:00', '2024-04-29 08:36:30', 1),
(5, '5', 5, 3001, 1, 'Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 70000, '2024-04-01 00:00:00', '0000-00-00 00:00:00', 0),
(6, '6', 6, 3002, 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 800000, '2024-04-01 00:00:00', '0000-00-00 00:00:00', 0),
(7, '7', 7, 4001, 2, 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 120000, '2024-04-01 00:00:00', '0000-00-00 00:00:00', 0),
(8, '8', 7, 4002, 4, 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 240000, '2024-04-01 00:00:00', '0000-00-00 00:00:00', 0),
(9, '9', 8, 3003, 2, 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.', 350000, '2024-04-01 00:00:00', '0000-00-00 00:00:00', 0),
(10, '10', 1, 1003, 4, 'Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 380000, '2024-04-01 00:00:00', '0000-00-00 00:00:00', 0),
(50, '12', 5, 2002, 12, '', 100000, '2024-04-28 21:22:03', NULL, 0);
...
CREATE TABLE `receive_goods` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=Inactive, 1=Approved'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `receive_goods` (`receive_id`, `po_id`, `receive_date`, `status`) VALUES
(5, 2, '2024-04-27', 1),
(6, 3, '2024-04-27', 1),
(7, 1, '2024-04-28', 1),
(8, 1, '2024-04-29', 1),
...
(1, 1, 1, 30000, '&lt;p&gt;Sample entry&lt;/p&gt;', '1', '2024-04-24 02:31:03', NULL),
(2, 1, 5, 1500, '&lt;p&gt;test&lt;/p&gt;', '1', '2024-04-24 02:33:29', NULL),
(3, 1, 5, 1500, '&lt;p&gt;test&lt;/p&gt;', '1', '2024-04-24 02:33:56', NULL),
(4, 1, 5, 1500, '&lt;p&gt;test&lt;/p&gt;', '1', '2024-04-24 02:34:17', NULL),
(5, 1, 5, 1500, '&lt;p&gt;test&lt;/p&gt;', '1', '2024-04-24 02:34:44', NULL),
(6, 1, 1, 2500, '&lt;p&gt;test&lt;/p&gt;', '1', '2024-04-24 02:36:32', NULL),
(7, 2, 1, 250, '&lt;p&gt;Sample expense&lt;/p&gt;', '', '2024-04-24 03:07:34', '2024-04-29 06:43:44'),
(8, 1, 1, 2555, '&lt;p&gt;test&lt;/p&gt;', '1', '2024-04-24 03:17:32', NULL),
(9, 2, 1, 2000, '&lt;p&gt;Sample expense&lt;/p&gt;', '1', '2024-04-24 03:36:10', NULL),
(10, 1, 3, 5000, '&lt;p&gt;Sample&lt;/p&gt;', '1', '2024-04-24 03:47:02', NULL),
(11, 1, 4, 3000, '&lt;p&gt;Test 103&lt;/p&gt;', '1', '2024-04-24 03:47:28', NULL),
(12, 1, 2, 2000, '&lt;p&gt;Test 103&lt;/p&gt;', '1', '2024-04-24 03:47:46', NULL),
(13, 1, 2, 3500, '&lt;p&gt;Test 106&lt;/p&gt;', '1', '2024-04-24 03:48:03', NULL),
(14, 2, 2, 800, '&lt;p&gt;Expense for Maintenance 105&lt;/p&gt;', '1', '2024-04-24 03:51:31', NULL);
...
CREATE TABLE `sales_orders` (
  ...
  `InvoiceID` int(11) NOT NULL,
  `Status` enum('Pending','Processing','Active','Cancelled') NOT NULL DEFAULT 'Pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `sales_orders` (`OrderID`, `OrderDate`, `Amount`, `MembershipPlanID`, `InvoiceID`, `Status`) VALUES
(1, '2024-03-27 10:48:02', '29000.00', 1, 1, 'Pending'),
(2, '2024-03-27 15:41:49', '29000.00', 2, 2, 'Pending'),
(3, '2024-03-27 15:41:52', '29000.00', 3, 3, 'Pending'),
(4, '2024-03-27 15:41:53', '29000.00', 1, 4, 'Pending'),
(5, '2024-03-27 15:41:53', '29000.00', 2, 5, 'Pending');
...
--
ALTER TABLE `material`
  MODIFY `material_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4003;
...
--
ALTER TABLE `course`
  ADD CONSTRAINT `fk_UserID_course` FOREIGN KEY (`UserID`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Constraints for table `receive_goods`
--
ALTER TABLE `receive_goods`
  ADD CONSTRAINT `fk_receive_goods_po_id` FOREIGN KEY (`po_id`) REFERENCES `purchase_order` (`po_id`) ON DELETE CASCADE ON UPDATE CASCADE;
